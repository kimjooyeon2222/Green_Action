...
public class GoogleSignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.community);  // Use the community layout
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() { // Corrected generic type
                    @Override
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            editor.putString("loggedInUserId", user.getUid()); // Save Firebase User ID
            editor.apply();
