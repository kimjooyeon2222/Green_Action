...
public class PlasticQuizSectionFragment extends Fragment {

    private static final String TAG = "PlasticQuizSectionFragment";
    ...
    public PlasticQuizSectionFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_plastic_pollution_quiz_section, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            pollutionType = getArguments().getString("POLLUTION_TYPE", "plastic_pollution");
        }
    ...
    private void handleButtonClick() {
        if (quizViewModel.getAttemptsLeft() > 0) {
            ...
            navigateToPlasticQuizListFragment();
        }
    }
    ...
    private void navigateToPlasticQuizListFragment() {
        FragmentManager fragmentManager = getParentFragmentManager();
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        transaction.replace(R.id.fragment_container, new PlasticQuizListFragment());
